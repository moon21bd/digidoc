...
class BoxCommentController extends AdminController
{
    /**
    ...
    {
        $form = new Form(new BoxComment);
        //$form->display("id", "ID");
        $form->number("box_id", __("Box Id"))->required();
        $form->text("title", __("Title"));

// user reference fields create here
        $form->hidden("created_by")->default(\Encore\Admin\Facades\Admin::user()->id);
    ...
    {
        $show = new Show(BoxComment::findOrFail($id));
